        ...
        <main id="main">
            <section id="team" class="team">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 rounded" v-for="u of getMyPostApplication">
                            <div class="member" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <div class="member-info">
                                    <h4 class="text-capitalize">{{u.fullname}}</h4>
                                    Age: <span class="text-capitalize">{{u.age}}</span>
                                    Skills: <span class="text-capitalize">{{u.skills}}</span>
                                    <div class="row mt-4 d-flex justify-content-end align-items-end me-2">
                                        <button class="btn btn-sm btn-danger col-5" @click="deleteThisApplication(u.appli_id)">
                                            Delete
                                        </button>
                                    </div>
                                </div>
